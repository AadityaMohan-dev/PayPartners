...
const signup = async () => {
    ...
    const {setIsAuthClose} = useContext(UserContext);
>>>>>>> Stashed changes
=======
...
function SignUp() {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8080/api/auth/user/signup', data);
  ...
  return (
    <section className="backdrop-blur-sm md:backdrop-blur-sm dark:bg-gray-900 fixed w-full h-full">
...
<<<<<<< HEAD
              <form class="space-y-4 md:space-y-6" action="#">
                  {/* <div>
                      <label  name='email'
        value={email}
        onChange={(e) => setEmail(e.target.value)} for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your email</label>
...
<<<<<<< Updated upstream
                  ...
                  <button type="submit" class="w-full text-blue-700 border border-blue-700 hover:bg-blue-700 hover:text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Create an account</button>
...
=======
   ...
   className=' bg-red-500 w-full text-white font-bold  px-2 py-2 rounded-lg'>
    Sign up
                  ...
                  {/* <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Already have an account? <a href="#" class="font-medium text-blue-900 hover:underline dark:text-primary-500">Login here</a>
                  </p> */}
>>>>>>> Stashed changes
              </form>
=======
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSignUp}>
              ...
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                ...
                <Link to="/login"
                  className="font-medium text-blue-900 hover:underline dark:text-primary-500"
                >
                  Login here
                </Link>
              </p>
