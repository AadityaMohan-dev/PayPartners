...
function SignIn() {
  ...
  return (
    <>
      <section class="backdrop-blur-sm md:backdrop-blur-sm dark:bg-gray-900 fixed w-full h-screen pt-3">
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" action="#">
                ...
                <p class="text-sm font-semibold  text-gray-500 dark:text-gray-400">
                  ...
                  <a
                    href="#"
                    class="font-medium text-blue-700 text-primary-600 hover:underline dark:text-primary-500"
                  >
                    Create new Account
                  </a>
                </p>
